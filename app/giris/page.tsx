...
export default function GirisPage() {
  ...
  const redirect = sp.get("redirect") || "/hesabim";
  ...
  return (
    <main
      style={{
        ...
        background: "radial-gradient(900px 500px at 30% 10%, rgba(212,175,55,0.10), transparent 55%), linear-gradient(180deg, #07030b, #020104)",
      }}
    >
      <div
        style={{
      ...
      >
        ...
        <p style={{ margin: "10px 0 0", color: "rgba(255,255,255,0.75)", lineHeight: 1.6 }}>
          Hesabına giriş yap, sepetini ve siparişlerini yönet.
        </p>
        ...
        <form onSubmit={onSubmit} style={{ marginTop: 22, display: "grid", gap: 14 }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", gap: 12, marginTop: 6 }}>
            <Link href="/kayit" style={linkStyle}>
